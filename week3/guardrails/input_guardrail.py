...
input_guardrail_agent = Agent(
    ...
    판단 기준:
    - 허용: 메뉴 조회, 음식 재료/알레르기 관련 질문, 주문 생성/조회/변경, 테이블 예약 관련 요청, 환불 관련 요청 등 문맥상 레스토랑 서비스와 관련된 모든 요청
    - 허용: 간단한 자기소개, 인사, 감사 표현 등 레스토랑 서비스와 무관하지만 대화의 흐름상 자연스러운 표현
    - 허용: "네", "그래", "응", "맞아요", "좋아요", "알겠어요", "아니요" 등 대화 흐름 상 단순 동의/확인/거절 표현
    - 허용: "감사합니다", "고마워요", "잘 부탁해요" 등 예의 바른 표현
